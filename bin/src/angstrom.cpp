...
static bool GenerateBlock(ChainstateManager& chainman, CBlock&& block, uint64_t& max_tries, std::shared_ptr<const CBlock>& block_out, bool process_new_block)
{
    ...
    if (!chainman.ProcessNewBlock(block_out, true, true, nullptr)) {
...
static UniValue generateBlocks(ChainstateManager& chainman, Mining& miner, const CScript& coinbase_output_script, int nGenerate, uint64_t nMaxTries)
{
    ...
    while (nGenerate > 0 && !chainman.m_interrupt) {
        ...
        if (!GenerateBlock(chainman, block_template->getBlock(), nMaxTries, block_out, true)) {
            break;
        }
...
static bool getScriptFromDescriptor(const std::string& descriptor, CScript& script, std::string& error)
{
    ...
    const auto descs = Parse(descriptor, key_provider, error,  false);
    ...
    return RPCHelpMan{"generateblock",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::STR_HEX, "hex", true, "hex of generated block, only present when submit=false"},
            }
        },
        RPCExamples{
    ...
    return RPCHelpMan{"getmininginfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::NUM, "currentblockweight", true, "The block weight of the last assembled block (only present if a block was ever assembled)"},
                        {RPCResult::Type::NUM, "currentblocktx", true, "The number of block transactions of the last assembled block (only present if a block was ever assembled)"},
                        ...
                        {RPCResult::Type::STR_HEX, "signet_challenge", true, "The block challenge (aka. block script), in hexadecimal (only present if the current network is a signet)"},
        ...
        RPCResult{
            RPCResult::Type::OBJ_DYN, "", "prioritisation keyed by txid",
            {
                {RPCResult::Type::OBJ, "<transactionid>", "", {
                    ...
                    {RPCResult::Type::NUM, "modified_fee", true, "modified fee in satoshis. Only returned if in_mempool=true"},
                }}
            },
        },
        RPCExamples{
    ...
    return RPCHelpMan{"getblocktemplate",
        ...
        "    https://github.com/bitcoin/bips/blob/master/bip-0145.mediawiki\n",
        {
            {"template_request", RPCArg::Type::OBJ, RPCArg::Optional::NO, "Format of the template",
            {
                ...
                {"capabilities", RPCArg::Type::ARR,  RPCArg::Optional::OMITTED, "A list of strings",
                {
        ...
        },
        {
            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "weightlimit", true, "limit of block weight"},
                ...
                {RPCResult::Type::STR_HEX, "signet_challenge", true, "Only on signet"},
                {RPCResult::Type::STR_HEX, "default_witness_commitment", true, "a valid witness commitment for the unmodified block template"},
            }},
        },
        RPCExamples{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!request.params[0].isNull())
    {
        ...
        if (strMode == "proposal")
        {
            ...
            BlockValidationState state;
            TestBlockValidity(state, chainman.GetParams(), chainman.ActiveChainstate(), block, chainman.m_blockman.LookupBlockIndex(block.hashPrevBlock), false, true);
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    BlockValidationState state;
    chainman.ProcessNewBlockHeaders({{h}}, true, state);
